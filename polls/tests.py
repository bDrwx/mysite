...
def create_question(question_text, days):
    ...
    return Qustion.objects.create(question_text=question_text, pub_date=time)
...
class QuestionModelTest(TestCase):
    def test_was_published_recently_with_future_question(self):
        ...
        future_question = Qustion(pub_date=time)
    ...
    def test_was_published_recently_with_old_question(self):
        ...
        old_question = Qustion(pub_date=time)
    ...
    def test_was_published_recently_with_recent_question(self):
        ...
        recent_question = Qustion(pub_date=time)
...
class QuestionIndexViesTests(TestCase):
    def test_no_questions(self):
        """
        If no questionsexist, an appropriaritate message is displayed.
        """
